package com.shpp.p2p.cs.kservetnyk.assignment6.hg.teest.gui;

import acm.graphics.GCanvas;
import acm.graphics.GLabel;
import acm.graphics.GRect;
import acm.io.IODialog;
import com.shpp.p2p.cs.kservetnyk.assignment6.hg.teest.ResultTypeHolder;
import com.shpp.p2p.cs.kservetnyk.assignment6.hg.teest.TeestResult;
...
public class ResultBox extends GCanvas implements MouseListener, ComponentListener {
    ...
    private static Map buildResultToDisplayMap() {
        ...
        result.put(ResultTypeHolder.ResultType.SUCCESS, new ResultInfo(Color.GREEN, "Pass"));
        result.put(ResultTypeHolder.ResultType.FAILURE, new ResultInfo(new Color(255, 127, 0), "Fail"));
        result.put(ResultTypeHolder.ResultType.EXCEPTION, new ResultInfo(Color.RED, "Error!"));
        return result;
    }
    ...
    public void setResult(TeestResult result) {
        this.result = result;
        ResultInfo info = (ResultInfo) resultToDisplay.get(result.getType());
